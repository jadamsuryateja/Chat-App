...
export default function RoomList({ onSelectRoom, onCreateRoom, onJoinRoom }: RoomListProps) {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Add padding class to main container */}
      <div className="p-4 md:p-6 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1rem,env(safe-area-inset-bottom))] px-[max(1rem,env(safe-area-inset-left))]">
        <div className="max-w-2xl mx-auto">
          ...
          {/* Add social links and developer credits */}
